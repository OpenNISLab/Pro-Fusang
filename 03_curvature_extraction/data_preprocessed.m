...
angle_num = 9;%The number of angles per object
angle = [0,20,40,60,90,120,140,160,180];%All possible angles

%List of experimental object names
file_path_name = 'Your local path\Fusang_dataset\object_information\221119_AllThingName.xlsx';%This is the file path for the list of experimental object names
...
original_data_file_path = 'Your local path\Fusang_dataset\leaves_feature_dataset\leaves_one_object\';

%File path to save the data of the training curvature model and test system 
generateModel_save_file_path = 'Your local path\Fusang_dataset\leaves_feature_dataset\lstm_dataset\';
ztest_system_save_file_path  = generateModel_save_file_path;

%The first half of the file name to be saved 
generateModel_part_save_file_name = 'generateModel_PDV_svmd_221119_';%Trained curvature model
ztest_system_part_save_file_name = 'ztestSystem_PDV_svmd_221119_';%To test the system
