...
"""
    Load training data
"""
# data_colm_path = r'Your local path\Pro-Fusang\00_Fusang_dataset\hrrp_formants_dataset\generateModel_data\columnNumber\1_0deg'
# data_valu_path = r'Your local path\Pro-Fusang\00_Fusang_dataset\hrrp_formants_dataset\generateModel_data\ExtremeValues\1_0deg'


"""
    Load test data
"""
data_colm_path = r'Your local path\Pro-Fusang\00_Fusang_dataset\hrrp_formants_dataset\ztest_system_data\columnNumber\1_0deg'
data_valu_path = r'Your local path\Pro-Fusang\00_Fusang_dataset\hrrp_formants_dataset\ztest_system_data\ExtremeValues\1_0deg'
