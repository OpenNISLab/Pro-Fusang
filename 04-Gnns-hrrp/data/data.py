...
from data.TUs import TUsDataset, ModifiedTUsDataset, FusangTUsDataset
...
def LoadData(DATASET_NAME):
    ...
    if 'Modified' in DATASET_NAME:
        return ModifiedTUsDataset(DATASET_NAME)

    if 'Fusang' in DATASET_NAME:
        return FusangTUsDataset(DATASET_NAME)
