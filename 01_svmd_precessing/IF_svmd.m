...
original_data_file_path = 'Your local path\Fusang_dataset\raw_radar_dataset\';

%Saved path of data processed by svmd algorithm
svmd_save_file_path = 'Your local path\Fusang_dataset\svmd_filtered_dataset\';

%The first half of the file name to be saved
part_save_file_name = 'svmd_Rx1_221119_';
